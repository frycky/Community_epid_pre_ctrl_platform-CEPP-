  ...
  <div class="login-wrap">
    <el-form class="login-container" :model="formModel" :rules="rules" ref="ruleForm">
      ...
      <el-form-item prop="email">
        <el-input type="text" v-model="formModel.email" placeholder="邮箱"></el-input>
      </el-form-item>
      <el-form-item prop="password">
        <el-input type="password" v-model="formModel.password" placeholder="用户密码"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="onSubmit('ruleForm')" style="width: 100%;">立即注册</el-button>
      </el-form-item>
    ...
    onSubmit(formName){
      this.$refs[formName].validate((valid)=>{
        if(valid){
          ...
          this.$axios.post("/user-info/register",this.formModel).then(res=>{
            console.log(res)
            if(res.code===200){
              this.$message({
                message:"注册成功，正在跳转",
