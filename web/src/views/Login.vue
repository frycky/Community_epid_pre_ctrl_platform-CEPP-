  ...
  <div class="login-wrap">
    <el-form class="login-container" :model="formModel" :rules="rules" ref="ruleForm">
      ...
      <el-form-item prop="username">
        <el-input type="text" v-model="formModel.username" placeholder="用户名"></el-input>
      </el-form-item>
      <el-form-item>
        <el-input type="password" v-model="formModel.password" placeholder="用户密码"></el-input>
      </el-form-item>
      <el-form-item>
        <!--        <el-button type="primary" v-on:@click="onSubmit()" style="width: 100%;">登陆</el-button>-->
        <el-button type="primary" @click="onSubmit('ruleForm')" style="width: 100%;">登录</el-button>
      </el-form-item>
